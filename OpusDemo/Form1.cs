...
namespace OpusDemo
{
    public partial class OpusDemo : Form
    {
        public OpusDemo()
        {
            InitializeComponent();
        ...
        private void OpusDemo_Load(object sender, EventArgs e)
        {
        ...
        void StartEncoding()
        {
            ...
            _bytesSent = 0;
            _segmentFrames = 960;
            _encoder = OpusEncoder.Create(48000, 1, FragLabs.Audio.Codecs.Application.Voip);
