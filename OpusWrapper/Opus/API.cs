...
namespace FragLabs.Audio.Codecs
{
    ...
    internal class API
    {
        ...
        { 
          ...
          /// <summary>
          ///  Best for broadcas/high-fidelity application  where the decoded audio  should be as close as  possilble to input.
          /// </summary>
          Audio  = 2049,

          
          /// <summary>
          /// Only use lowest-achiavable latency is what matters most.  Voice-optimized modes cannot be used.
          /// </summary>
        ...
        public enum Errors
        {
            ...
            /// <summary>
            ///  Invalid/unsopported  request number.
            /// </summary>
            Unimplemented = -5, 
